  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Typography variant="h2" className="sideBarHeader" component={'h2'}>
          The King's Restaurant
        </Typography>
        <Typography variant="h5" className="sideBarSubtext" component={"h3"}>
          Dashboard Owner
        </Typography>
        <List>
          {["Dashboard", "FAQ Page"].map((text, index) => (
            <ListItem key={text} disablePadding className="sideBarHeadings">
              <ListItemButton>
                <ListItemIcon>
                  {index % 2 === 0 ? (
                    <HomeOutlinedIcon />
